...
<table class="table" align="center" style="height:auto">
	 <tr>
		 <td colspan="3" >
			<iframe class="blog_top" src="index.php?a=blog_top" frameborder="0" scrolling="no"></iframe>
		 </td>
 	</tr>
    <tr>
		<td width="20%">
        ...
        <form action="index.php?c=Article&a=search" method="post" target="center">
                <div class="panel_Search">
                    <ul class="panel_head"><span>文章搜索</span></ul>
                    <ul class="panel_body">
                        <span><input id="inputSearch" name="search" type="text" class="blogsearch" title="请输入关键字"></span>
                        <input class="btnSubmit"  type="submit" value="搜索" title="search in blog" id="search_btn">
		 ...
		 <td width="60%">
			<iframe class="blog_center" name="center"  src="index.php?c=Article&a=getLimitBlogs" frameborder="0" scrolling="no" ></iframe>
		 </td>
		 <td width="20%">
			<iframe class="blog_right"  src="index.php?a=right_panel" frameborder="0" scrolling="no"></iframe>
		 </td>
 	</tr>
