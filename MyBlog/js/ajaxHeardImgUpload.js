$(document).ready(function(){
    ...
    $(document).on('change','#heardImgUpload',function(){
        ajaxHeardImgUpload();
...
//上传头像图片的方法，
function ajaxHeardImgUpload(){
    //调用ajaxfileupload.js中的方法
    $.ajaxFileUpload({
        url:'/MyBlog/index.php?p=back&c=Uploader&a=uploaderHeard',//上传图片要提交到的PHP后台Action方法
        secureuri:false,//是否用安全提交，默认为false
        fileElementId:'heardImgUpload',//file选择文件的框的id
